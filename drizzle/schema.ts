...
export const documents = mysqlTable("documents", {
  ...
  documentType: mysqlEnum("documentType", ["medical", "report", "scan", "other"]).default("medical").notNull(),
  status: mysqlEnum("status", ["draft", "pending", "analyzed", "reviewed", "archived"]).default("draft").notNull(),
...
export const images = mysqlTable("images", {
  ...
  imageType: mysqlEnum("imageType", ["xray", "mri", "ct", "ultrasound", "photo", "document", "other"]),
...
export const analysisResults = mysqlTable("analysisResults", {
  ...
  severity: mysqlEnum("severity", ["normal", "mild", "moderate", "severe", "critical"]),
...
export const subscriptions = mysqlTable("subscriptions", {
  ...
  status: mysqlEnum("status", ["active", "canceled", "expired", "suspended"]).default("active").notNull(),
