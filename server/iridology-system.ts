...
export const IRIS_ZONES: IrisZone[] = [
  ...
  },
  {
    ...
    relatedOrgans: ['colon', 'small intestine', 'large intestine', 'rectum', 'cecum', 'appendix', 'duodenum']
  },
  {
    id: 3,
  ...
  },
  {
    ...
    relatedOrgans: ['heart', 'lungs', 'liver', 'gallbladder', 'pancreas', 'spleen', 'kidneys']
  },
  {
    id: 5,
  ...
  },
  {
    ...
    relatedOrgans: ['lymphatic system', 'immune system', 'lymph nodes', 'spleen']
  },
  {
    id: 7,
...
export const ORGAN_POSITIONS: OrganMapping[] = [
  // Digestive System
  { organ: 'Oral Cavity', leftEye: { zone: 2, position: '12:00' }, rightEye: { zone: 2, position: '12:00' }, system: 'Digestive' },
  { organ: 'Stomach', leftEye: { zone: 1, position: 'center' }, rightEye: { zone: 1, position: 'center' }, system: 'Digestive' },
  { organ: 'Small Intestine', leftEye: { zone: 2, position: '6:00-9:00' }, rightEye: { zone: 2, position: '3:00-6:00' }, system: 'Digestive' },
  { organ: 'Ascending Colon', leftEye: { zone: 2, position: '3:00-6:00' }, rightEye: { zone: 2, position: '3:00-6:00' }, system: 'Digestive' },
  { organ: 'Transverse Colon', leftEye: { zone: 2, position: '12:00-3:00' }, rightEye: { zone: 2, position: '9:00-12:00' }, system: 'Digestive' },
  { organ: 'Descending Colon', leftEye: { zone: 2, position: '6:00-9:00' }, rightEye: { zone: 2, position: '6:00-9:00' }, system: 'Digestive' },
  { organ: 'Pancreas Head', leftEye: { zone: 4, position: '7:30' }, rightEye: { zone: 4, position: '7:30' }, system: 'Digestive' },
  { organ: 'Pancreas Tail', leftEye: { zone: 4, position: '7:00' }, rightEye: { zone: 4, position: '7:00' }, system: 'Digestive' },
  { organ: 'Liver', leftEye: { zone: 4, position: '7:50' }, rightEye: { zone: 4, position: '7:50' }, system: 'Digestive' },
  { organ: 'Gallbladder', leftEye: { zone: 4, position: '7:50' }, rightEye: { zone: 4, position: '7:50' }, system: 'Digestive' },
  { organ: 'Spleen', leftEye: { zone: 4, position: '8:30' }, rightEye: { zone: 4, position: '8:30' }, system: 'Digestive' },
  
  // Respiratory System
  { organ: 'Nasal Cavity', leftEye: { zone: 6, position: '2:00-3:00' }, rightEye: { zone: 6, position: '9:00-10:00' }, system: 'Respiratory' },
  { organ: 'Paranasal Sinus', leftEye: { zone: 6, position: '2:00-3:00' }, rightEye: { zone: 6, position: '9:00-10:00' }, system: 'Respiratory' },
  { organ: 'Left Lung', leftEye: { zone: 5, position: '9:00' }, rightEye: { zone: 5, position: '9:00' }, system: 'Respiratory' },
  { organ: 'Right Lung', leftEye: { zone: 5, position: '3:00' }, rightEye: { zone: 5, position: '3:00' }, system: 'Respiratory' },
  
  // Circulatory System
  { organ: 'Heart', leftEye: { zone: 4, position: '3:00' }, rightEye: { zone: 4, position: '3:00' }, system: 'Circulatory' },
  
  // Endocrine System
  { organ: 'Thyroid', leftEye: { zone: 4, position: '2:00-3:00' }, rightEye: { zone: 4, position: '9:00-10:00' }, system: 'Endocrine' },
  { organ: 'Parathyroid', leftEye: { zone: 4, position: '2:00-3:00' }, rightEye: { zone: 4, position: '9:00-10:00' }, system: 'Endocrine' },
  { organ: 'Adrenals', leftEye: { zone: 4, position: '4:30' }, rightEye: { zone: 4, position: '7:30' }, system: 'Endocrine' },
  { organ: 'Pituitary', leftEye: { zone: 4, position: '12:00' }, rightEye: { zone: 4, position: '12:00' }, system: 'Endocrine' },
  
  // Nervous System
  { organ: 'Lumbar Vertebrae', leftEye: { zone: 5, position: '5:00-7:00' }, rightEye: { zone: 5, position: '5:00-7:00' }, system: 'Nervous' },
  
  // Urinary System
  { organ: 'Kidneys', leftEye: { zone: 4, position: '5:30' }, rightEye: { zone: 4, position: '6:30' }, system: 'Urinary' },
  { organ: 'Bladder', leftEye: { zone: 4, position: '6:00' }, rightEye: { zone: 4, position: '6:00' }, system: 'Urinary' }
];
...
export const SIGN_MEANINGS = {
  ...
  arcus: {
    white: {
      ...
      severity: 'moderate' as const,
      symptoms: ['High cholesterol', 'Circulation issues', 'Cardiovascular risk']
    }
  },
  pigment: {
    brown: {
...
export const SYSTEM_SYMPTOMS = {
  Digestive: {
    stomach: {
      ...
      moderate: ['Frequent indigestion', 'Acid reflux', 'Stomach pain', 'Bloating'],
      severe: ['Chronic pain', 'Severe reflux', 'Ulcer symptoms', 'Malnutrition']
    },
    intestine: {
      normal: ['Regular bowel movements', 'Good absorption', 'No pain'],
      mild: ['Occasional constipation', 'Mild bloating', 'Gas'],
      moderate: ['Irregular bowel', 'Chronic constipation', 'Diarrhea', 'Malabsorption'],
      severe: ['Severe pain', 'Chronic diarrhea', 'Intestinal dysfunction', 'Malnutrition']
    },
    liver: {
      ...
      severe: ['Severe fatigue', 'Jaundice', 'Liver dysfunction', 'Poor absorption']
    },
    pancreas: {
      normal: ['Stable blood sugar', 'Good digestion', 'No pain'],
      mild: ['Mild blood sugar fluctuation', 'Occasional digestive issues'],
      moderate: ['Blood sugar instability', 'Digestive problems', 'Abdominal pain'],
  ...
  Respiratory: {
    nasal: {
      ...
      severe: ['Severe congestion', 'Chronic sinusitis', 'Breathing difficulty']
    },
    lungs: {
  ...
  Circulatory: {
    ...
    circulation: {
      ...
      severe: ['Severe circulation issues', 'Chronic swelling', 'Cardiovascular problems']
    }
  },
  Endocrine: {
    thyroid: {
      ...
      moderate: ['Metabolic issues', 'Fatigue', 'Weight problems', 'Temperature sensitivity'],
      severe: ['Thyroid dysfunction', 'Severe metabolic issues', 'Chronic fatigue']
    },
    adrenals: {
      normal: ['Good stress response', 'Stable energy', 'Healthy blood pressure'],
      mild: ['Mild fatigue', 'Occasional stress'],
      moderate: ['Chronic fatigue', 'Stress sensitivity', 'Blood pressure issues'],
...
export function analyzeIrisSigns(signs: IrisSign[]): IridologyAnalysis {
  ...
  signs.forEach(sign => {
    ...
    const organ = findOrganByPosition(sign.location.zone, sign.location.position);
    if (organ) {
  ...
  if (severeConcerns.length > 0) {
    ...
    overallHealth = 'Overall iris analysis shows good health indicators with minor areas for improvement.';
  }
  ...
  Array.from(systemsAffected).forEach(system => {
    const systemRecs = HEALTH_RECOMMENDATIONS[system as keyof typeof HEALTH_RECOMMENDATIONS];
...
function findOrganByPosition(zone: number, position: string): OrganMapping | undefined {
  // Simplified position matching - in real implementation, use precise angle calculations
  return ORGAN_POSITIONS.find(organ => 
    organ.leftEye.zone === zone || organ.rightEye.zone === zone
  );
}

function generateOrganFinding(organ: OrganMapping, signs: IrisSign[]): IridologyFinding {
  ...
  const systemSymptoms = SYSTEM_SYMPTOMS[organ.system as keyof typeof SYSTEM_SYMPTOMS];
  
  if (systemSymptoms && typeof systemSymptoms === 'object') {
    const organSymptoms = Object.values(systemSymptoms).find((s: any) => s[maxSeverity]);
    if (organSymptoms) {
  ...
  const systemRecs = HEALTH_RECOMMENDATIONS[organ.system as keyof typeof HEALTH_RECOMMENDATIONS];
